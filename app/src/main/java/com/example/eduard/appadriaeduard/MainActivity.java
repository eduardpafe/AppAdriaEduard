    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        botoPS4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(view.getContext(), Ps4.class);
        ...
        botoXBOX.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(view.getContext(), Xbox.class);
                startActivityForResult(intent, 0);
            }
        });
        ...
        botoWIIU.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(view.getContext(), Wiiu.class);
                startActivityForResult(intent, 0);
            }
        });
